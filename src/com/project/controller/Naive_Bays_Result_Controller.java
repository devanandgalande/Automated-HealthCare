...
import com.project.algo.NaiveBaysClassification;
 ...
 */
@WebServlet("/Naive_Bays_Result_Controller")
public class Naive_Bays_Result_Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Naive_Bays_Result_Controller() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		NaiveBaysClassification nb=new NaiveBaysClassification();
		...
		for(int i=0; i<patients_details.size(); i++)
		{
			...
			final_disease=nb.classify(list1, list2, list3, list4, list5);
			
			System.out.println("Final Disease Name in NB Controller= "+final_disease);
			...
			if(final_disease!= null && !final_disease.isEmpty())
			 {	
				...
				ed.sendEmail(patient_email,patient_name,patient_loc,patient_symptom1,patient_symptom2,patient_symptom3,patient_symptom4,patient_symptom5,final_disease,treatment,doc_name,doc_cont);
			}
		...
		if(final_result_list.size()!=0)
		{
			...
			//out.println("alert('See Final NB Results!!!');");
			out.println("location='patient_view_final_NaiveBayes_results.jsp';");
			out.println("</script>");
		}
		else
		{
