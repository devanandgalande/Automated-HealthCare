...
public class NaiveBaysClassification {
	...
	public static int probability_negative_count=0;
    ...
    HashMap<Float,String> result_map=new HashMap<Float,String>();
	...
	public String classify (ArrayList<Disease_Bean> list1, ArrayList<Disease_Bean> list2, ArrayList<Disease_Bean> list3, ArrayList<Disease_Bean> list4, ArrayList<Disease_Bean> list5)
	{
		...
		/**************************************************************/
		  //count symptoms
		  if(symptoms_cnt_list.size()>0)
		  {
		   for(Map.Entry<String,Integer> m:disease_occ_list.entrySet())
		    {    
			   occ_list.add(Integer.parseInt(m.getValue().toString()));// 
		    }
		  }
		  
		  for(int j=0; j<occ_list.size();j++)
		   {
			  System.out.println("Occurance list= "+occ_list.get(j));
		   }
		 /**************************************************************/
		  ...
		  int cnt=0;
		    for(Map.Entry<String,Integer> m:symptoms_cnt_list.entrySet())
		     {    
			  
			  float prob=(float)occ_list.get(cnt)/m.getValue();
			  System.out.println("prob= "+prob);
		      result_map.put(prob, m.getKey());
		      cnt++;  
		     }
		  
		    Float maxKey = Collections.max(result_map.keySet());
		...
		System.out.println("Final Disease Name in NB Class= "+final_disease);
