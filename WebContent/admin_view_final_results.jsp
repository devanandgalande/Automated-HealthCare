  ...
  <body>
	...
	<div class="row">
      <div class="col-md-12">
              ...
              <h2 align="center" style="color:maroon;font:bold;">FINAL PATIENTS RESULT</h2>
              <br>
              <br>
     <div class="col-md-2"></div>
      ...
      <tr >
		...
		<th style="width: 70px" class="text-center"> PATIENT SYMPTOMS</th>
     ...
     <tbody>
              ...
              <tr>
		         ...
		         <td style="border-color: black; color:green" align="center"><%=bean.getDoc_name()%></td>
