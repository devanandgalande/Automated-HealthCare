  ...
  <body>
	...
	<div class="row">
      <div class="col-md-12">
              ...
              <h2 align="center" style="color:maroon;font:bold;">RESULT DETAILS</h2>
              <br>
              <br>
     <div class="col-md-2"></div>
	  ...
	  <tr >
		...
		<th style="width: 70px" class="text-center"> PATIENT SYMPTOMS_1</th>
		<th style="width: 70px" class="text-center"> PATIENT SYMPTOMS_2</th>
		<th style="width: 70px" class="text-center"> PATIENT SYMPTOMS_3</th>
     ...
     <tbody>
               <%
                ...
                %>
              <tr>
		         <td style="border-color: black; color:blue;" align="center"><%=i+1 %></td>
		         ...
		         <td style="border-color: black; color:green" align="center"><%=bean.getPatient_symptom_1() %></td>
		         <td style="border-color: black; color:green" align="center"><%=bean.getPatient_symptom_2() %></td>
		         <td style="border-color: black; color:green" align="center"><%=bean.getPatient_symptom_3() %></td>
