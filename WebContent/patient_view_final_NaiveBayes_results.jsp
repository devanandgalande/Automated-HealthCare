	...
	<div class="row">
     ...
     <div class="col-md-2"></div>
	  ...
	  <tr >
		...
		<th style="width: 150px" class="text-center"> PATIENT SYMPTOMS</th>
		<th style="width: 100px" class="text-center"> DISEASE NAME</th>
	    <th style="width: 150px" class="text-center"> TREATEMENT</th>
	  </tr>
     </thead>
     <tbody>
               <%
